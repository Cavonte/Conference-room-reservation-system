...
public class Waitlist extends View {

    private String mExampleString; // TODO: use a default from R.string...
    private String roomNumber, day, hours, location, presentation, waitlist;
    ...
    public Waitlist(Context context) {
        super(context);
        init(null, 0);
    }

    public Waitlist(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public Waitlist(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        waitlist = a.getString(R.styleable.Reservation_waitlist);
...
//
        ...
        canvas.drawText(location, paddingLeft, textPadding + paddingTop + 3 * (contentHeight + mTextHeight) / 10, mTextPaint);

        canvas.drawText(waitlist, paddingLeft, textPadding + paddingTop + 5 * (contentHeight + mTextHeight) / 10, mTextPaint);
